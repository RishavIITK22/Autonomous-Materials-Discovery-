...
To set up this locally(preferred), in order to further develop, follow the given steps:
  ...
  2. Next follow steps from :https://github.com/RishavIITK22/LLMatDesign.git
  3. Next run the web_app.py or web_app_updated.py in the .notebooks/ directory as mentioned in this repo to run the web app script.
